...
@Getter
public class CheckSocialResponseDto extends ResponseDto {

    private CheckSocialResponseDto() {
        super(ResponseCode.SUCCESS, ResponseMessage.SUCCESS);
    }

    public static ResponseEntity<CheckSocialResponseDto> success() {
        CheckSocialResponseDto result = new CheckSocialResponseDto();
